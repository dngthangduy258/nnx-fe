...
import { LayoutDashboard, ShoppingBasket, ClipboardList, LogOut, Package, ArrowLeft, Menu, X, Layers, Upload, Database } from 'lucide-react';
...
const AdminLayout = () => {
    ...
    const menuItems = [
        ...
        { title: 'Công cụ hàng loạt', path: '/admin/bulk-tools', icon: Upload },
        { title: 'Đơn hàng', path: '/admin/orders', icon: ClipboardList },
        { title: 'Dữ liệu / SQL', path: '/admin/data', icon: Database },
    ];
